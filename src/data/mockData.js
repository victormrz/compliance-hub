...
export const incidents = [
  { id: 1, date: "2026-01-31", type: "Fall", facility: "Roaring Brook Recovery", severity: "Minor", reportedBy: "Kara Brown-Flod", description: "Client slipped in bathroom", investigationStatus: "Resolved", correctiveAction: "Non-slip mats installed", resolutionDate: "2026-02-05", rootCause: "Wet floor", standardRef: "EC.02.06.01" },
  { id: 2, date: "2026-02-09", type: "Medication Error", facility: "Roaring Brook Recovery", severity: "Moderate", reportedBy: "Laurel Yoder", description: "Wrong dosage administered", investigationStatus: "Under Review", correctiveAction: "Double-check protocol implemented", resolutionDate: null, rootCause: null, standardRef: "PC.01.02.01" },
  { id: 3, date: "2026-02-04", type: "Self Harm", facility: "Roaring Brook Recovery", severity: "Critical", reportedBy: "Harold Kantar", description: "Client self-harm attempt", investigationStatus: "RCA In Progress", correctiveAction: "Increased monitoring, ligature risk reassessment", resolutionDate: null, rootCause: null, standardRef: "PC.01.02.01" },
  { id: 4, date: "2026-03-01", type: "AMA/Elopement", facility: "Roaring Brook Recovery", severity: "Moderate", reportedBy: "Jarrod Chase", description: "Client left AMA", investigationStatus: "Closed", correctiveAction: "Discharge protocols reviewed", resolutionDate: "2026-03-03", rootCause: "Inadequate engagement", standardRef: "RI.01.01.01" },
];
...
export const contracts = [
  ...
  { id: 2, vendor: "Quest Diagnostics", type: "BAA", startDate: "2024-06-01", endDate: "2027-06-01", autoRenew: true, annualValue: 12000, status: "Active", owner: "Alison Grigsby" },
  { id: 3, vendor: "Lexington Fire Protection", type: "Service Agreement", startDate: "2025-01-01", endDate: "2026-12-31", autoRenew: false, annualValue: 4800, status: "Active", owner: "Dave Thomas" },
  { id: 4, vendor: "Sysco Food Service", type: "Vendor", startDate: "2024-01-01", endDate: "2026-12-31", autoRenew: true, annualValue: 96000, status: "Active", owner: "Dave Thomas" },
  { id: 5, vendor: "SecureShred", type: "BAA", startDate: "2024-03-01", endDate: "2026-03-01", autoRenew: true, annualValue: 2400, status: "Expiring Soon", owner: "Rebecca Milton" },
];

// ── Regulatory Changes — tracks CARF, TJC, KY-DBHDID, and Federal updates ──
export const regulatoryChanges = [
  { id: 1, date: '2026-01-15', body: 'CARF', changeType: 'Standard Revision', title: 'Updated Quality Improvement Standards (1.A.4)', description: 'CARF revised QI outcome measurement requirements to include patient-reported outcome measures (PROMs).', impactedStandards: ['1.A.4'], actionRequired: 'Update QI plan to include validated PROM tool. Add PROM tracking to intake and discharge.', dueDate: '2026-06-30', assignedTo: 'Rebecca Milton', status: 'In Progress', priority: 'High', notes: 'PHQ-9 selected as primary PROM.' },
  { id: 2, date: '2026-02-01', body: 'TJC', changeType: 'New Requirement', title: 'Behavioral Health Ligature Risk Requirements (EC.02.06.05)', description: 'TJC issued updated environmental risk assessment requirements effective July 2026.', impactedStandards: ['EC.02.06.01'], actionRequired: 'Conduct facility-wide ligature risk reassessment using new TJC matrix. Update CAPs.', dueDate: '2026-07-01', assignedTo: 'Dave Thomas', status: 'Not Started', priority: 'Critical', notes: 'New risk matrix from TJC Perspectives, Feb 2026.' },
...
export const evidence = [
  ...
  { id: 2, documentName: "Emergency Operations Plan", standardCode: "EC.02.06.01", standardName: "Emergency management planning activities", status: "Current", location: "TJC/EC - Environment of Care", lastUpdated: "2025-08-15", uploadedBy: "Dave Thomas", notes: "Updated after annual review" },
  { id: 3, documentName: "HIPAA Privacy Training Records", standardCode: "45 CFR 164.530", standardName: "Administrative requirements - Training", status: "Current", location: "Federal/HIPAA Training", lastUpdated: "2026-02-10", uploadedBy: "Rebecca Milton", notes: "" },
  { id: 4, documentName: "Fire Drill Logs Q1 2026", standardCode: "1.H.7", standardName: "Fire safety and emergency drills", status: "Current", location: "CARF 2025/1H - Health & Safety", lastUpdated: "2026-03-01", uploadedBy: "Dave Thomas", notes: "Quarterly drill documentation" },
  { id: 5, documentName: "Suicide Risk Assessment Protocol", standardCode: "PC.01.02.01", standardName: "Suicide risk screening and assessment", status: "Under Review", location: "TJC/PC - Provision of Care", lastUpdated: "2025-12-15", uploadedBy: "Hillary Nolan", notes: "Updating per new TJC clarification" },
  ...
  { id: 7, documentName: "Medication Management Policy", standardCode: "PC.01.02.01", standardName: "Medication management protocols", status: "Outdated", location: "TJC/PC - Provision of Care", lastUpdated: "2024-09-01", uploadedBy: "Laurel Yoder", notes: "Needs revision per latest formulary changes" },
  { id: 8, documentName: "42 CFR Part 2 Consent Forms", standardCode: "42 CFR 2.31", standardName: "Consent for disclosure requirements", status: "Under Review", location: "Federal/42 CFR Part 2", lastUpdated: "2026-02-20", uploadedBy: "Rebecca Milton", notes: "New forms drafted for HIPAA alignment" },
  ...
  { id: 10, documentName: "Trauma-Informed Care Training Certificates", standardCode: "1.K.1", standardName: "Workforce development - Trauma-informed training", status: "Current", location: "CARF 2025/1K - Workforce", lastUpdated: "2026-01-20", uploadedBy: "Hillary Nolan", notes: "All staff completed TIC module" },
  { id: 11, documentName: "Infection Control Plan", standardCode: "1.H.12", standardName: "Infection prevention and control", status: "Current", location: "CARF 2025/1H - Health & Safety", lastUpdated: "2025-07-20", uploadedBy: "Laurel Yoder", notes: "" },
  { id: 12, documentName: "Patient Rights & Grievance Procedure", standardCode: "RI.01.01.01", standardName: "Patient rights information", status: "Outdated", location: "TJC/RI - Rights & Responsibilities", lastUpdated: "2024-05-10", uploadedBy: "Rebecca Milton", notes: "Annual revision overdue" },
  ...
  { id: 14, documentName: "Quality Improvement Plan 2026", standardCode: "1.A.4", standardName: "Quality improvement outcome measurement", status: "Under Review", location: "CARF 2025/1A - Leadership", lastUpdated: "2026-02-28", uploadedBy: "Rebecca Milton", notes: "Adding PROM tracking per CARF revision" },
...
export const auditLog = [
  { id: 'audit-001', timestamp: '2026-03-13T08:15:00Z', action: 'Create', entity: 'Incidents', recordId: '4', recordName: 'AMA/Elopement', userName: 'Jarrod Chase', userEmail: 'jarrod.chase@roaringbrookrecovery.com', userRole: 'end_user', changes: '{"type":"AMA/Elopement","severity":"Moderate"}', summary: 'Created new Incident: AMA/Elopement' },
  { id: 'audit-002', timestamp: '2026-03-12T14:30:00Z', action: 'Update', entity: 'Standards', recordId: '1', recordName: 'Staff Competency Assessment', userName: 'Hillary Nolan', userEmail: 'hillary.nolan@roaringbrookrecovery.com', userRole: 'manager', changes: '{"evidenceRequired":{"old":["Competency Checklists","License Verifications"],"new":["Competency Checklists","License Verifications","Performance Evaluations"]}}', summary: 'Updated Staff Competency Assessment in Standards (1 field changed)' },
  ...
  { id: 'audit-004', timestamp: '2026-03-11T16:45:00Z', action: 'Update', entity: 'Policies', recordId: '3', recordName: 'HIPAA Privacy Policy', userName: 'Rebecca Milton', userEmail: 'rebecca.milton@roaringbrookrecovery.com', userRole: 'manager', changes: '{"version":{"old":"3.9","new":"4.0"}}', summary: 'Updated HIPAA Privacy Policy in Policies (1 field changed)' },
  { id: 'audit-005', timestamp: '2026-03-11T09:20:00Z', action: 'Update', entity: 'Incidents', recordId: '2', recordName: 'Medication Error', userName: 'Amber Ramsay', userEmail: 'amber.ramsay@roaringbrookrecovery.com', userRole: 'manager', changes: '{"investigationStatus":{"old":"RCA In Progress","new":"Under Review"}}', summary: 'Updated Medication Error in Incidents (1 field changed)' },
  { id: 'audit-006', timestamp: '2026-03-10T13:00:00Z', action: 'Create', entity: 'Personnel', recordId: '8', recordName: 'Kara Brown-Flod', userName: 'Victor Rivera', userEmail: 'victor@roaringbrookrecovery.com', userRole: 'admin', changes: '{"name":"Kara Brown-Flod","title":"Staff"}', summary: 'Created new Personnel: Kara Brown-Flod' },
  { id: 'audit-007', timestamp: '2026-03-10T11:30:00Z', action: 'Update', entity: 'Credentials', recordId: '3', recordName: 'Laurel Yoder - RN License', userName: 'Kelsey Hess', userEmail: 'kelsey.hess@roaringbrookrecovery.com', userRole: 'manager', changes: '{"status":{"old":"Active","new":"Critical"}}', summary: 'Updated Laurel Yoder - RN License in Credentials (1 field changed)' },
  { id: 'audit-008', timestamp: '2026-03-09T15:10:00Z', action: 'Create', entity: 'EOCInspections', recordId: '3', recordName: 'Safety Walkthrough - March', userName: 'Dave Thomas', userEmail: 'dave.thomas@roaringbrookrecovery.com', userRole: 'end_user', changes: '{"type":"Safety Walkthrough","area":"All Areas"}', summary: 'Created new EOCInspection: Safety Walkthrough - March' },
  ...
  { id: 'audit-010', timestamp: '2026-03-07T14:20:00Z', action: 'Update', entity: 'Training', recordId: '1', recordName: 'CPR/BLS Certification', userName: 'Tiffany Spradlin', userEmail: 'tiffany.spradlin@roaringbrookrecovery.com', userRole: 'manager', changes: '{"duration":{"old":"3 hrs","new":"4 hrs"}}', summary: 'Updated CPR/BLS Certification duration in Training' },
  { id: 'audit-011', timestamp: '2026-03-06T10:00:00Z', action: 'Create', entity: 'RegulatoryChanges', recordId: '7', recordName: 'AODE 24hr Reporting', userName: 'Alison Grigsby', userEmail: 'alison.grigsby@roaringbrookrecovery.com', userRole: 'manager', changes: '{"body":"KY-DBHDID","priority":"Critical"}', summary: 'Created new RegulatoryChange: AODE 24hr Reporting' },
